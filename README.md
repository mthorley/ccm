...
**NIST SP 800-53 r5.2.0** — families → controls, evidenced controls highlighted and labelled; click a family to zoom (second image: the SC family, with SC-8(1) lit on the enhancement ring):
